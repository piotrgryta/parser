...
//import com.parser.parser.VisitorOrientedParser;
...
////        final Class listenerOutput = new newListenerOrientedParser().parse(someLangSourceCode);
//        final ClassEntity visitorOutput = new VisitorOrientedParser().parse(someLangSourceCode);
